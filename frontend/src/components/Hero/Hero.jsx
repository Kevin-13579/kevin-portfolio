        ...
        <div className="light-split-wrapper">
          <div className="light-text-block">
            ...
            <p className="light-para-summary">
              Full-Stack Developer & DevOps Enthusiast<br/>
            ...
            {/* Stats Glass Box */}
            <div className="hero-stats-box glass-surface stagger-reveal" style={{ animationDelay: '0.3s', padding: '15px 20px', display: 'inline-block', marginBottom: '2.5rem', fontWeight: '600' }}>
              5+ Projects Completed &nbsp;|&nbsp; 10+ Certifications
            </div>
            ...
            <div className="light-buttons-cluster">
              ...
              <div className="light-social-icons">
                ...
                <a href="#" target="_blank" rel="noreferrer" className="social-icon-btn" title="LeetCode">
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M16.102 17.93l-2.697 2.607c-.466.467-1.111.662-1.823.662s-1.357-.195-1.824-.662l-4.332-4.363c-.467-.467-.702-1.15-.702-1.863s.235-1.396.702-1.863l4.332-4.363c.467-.467 1.112-.662 1.824-.662s1.357.195 1.823.662l2.697 2.607c.868.868 2.44 2.508 2.44 2.508s1.614-1.583 2.477-2.45c.863-.863 2.37-2.31 2.37-2.31s-1.542-1.488-2.404-2.35L16.102 3.65C15.635 3.183 14.99 2.988 14.278 2.988s-1.357.195-1.824.662L8.122 8.013C7.655 8.48 7.42 9.163 7.42 9.876s.235 1.396.702 1.863l4.332 4.363c.467.467 1.112.662 1.824.662s1.357-.195 1.823-.662l2.697-2.607c.868-.868 2.44-2.508 2.44-2.508s1.614 1.583 2.477 2.45c.863.863 2.37 2.31 2.37 2.31s-1.542 1.488-2.404 2.35l-4.887 4.757z"/></svg>
                </a>
                <a href="#" target="_blank" rel="noreferrer" className="social-icon-btn" title="HackerRank">
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.666 16.536l-2.029.742-1.748-4.148H10.11l-1.748 4.148-2.029-.742 4.148-9.84h3.033l4.152 9.84zM12 5.674l-2.271 5.385h4.542L12 5.674z"/></svg>
                </a>
              </div>
            </div>
          </div>
